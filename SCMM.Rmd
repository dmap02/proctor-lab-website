...
<table style="border-collapse:collapse; width:100%;">
  ...
  <tr>
    ...
    <td style="padding:6px;">Elevator talks (3 min each) (Chair: Diana Proctor)</td>
  </tr>
  <tr>
...
<div style="text-align:left;">
  <ul>
    <li><strong>Diana M. Proctor</strong> — Assistant Professor, UTHealth Houston McGovern Medical School</li>
