...
<strong>Conference rooms:</strong> BRC Event Hall<br>

</p>

<p><strong> Parking Information</strong><br>
<p>
We strongly encourage attendees to walk or park at the conference hotel whenever possible. Limited parking is available at the BRC Garage for those who need it, but spaces are not guaranteed. Shuttles will run between the BRC, Valhalla, and Hungry’s and back to the hotel, so cars are not needed at the site.
</p>

<p><strong> BRC Garage Details</strong><br>
<p>
The garage entrance is located off <strong>Dryden Rd.</strong> Parking is <strong>credit-card only</strong>:
</p>
<ul>
...
<ul>
  <li>
    ...
    <a href="SCMM2025NetworkingPrimer.docx" 
       target="_blank" rel="noopener" 
       style="margin-left:8px;">
       Networking Tips & Tricks (SCMM 2025 Primer)
    </a>

    <a href="SCMM_Bios-2.docx" 
       target="_blank" rel="noopener" 
       style="margin-left:8px;">
