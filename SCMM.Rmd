...
<p style="text-align:left;">
  <a href="SCMM_Schedule_Final.docx" download>
    Download the FULL Schedule here.
  </a>
</p>

<p style="text-align:left;">
  <a href="SCMM_abstracts_v6.0.docx" download>
...
<table style="border-collapse:collapse; width:100%;">
  ...
  <tr>
    ...
    <td style="padding:6px;">Bus departs from the BRC (75-person meeting) to Keck Hall/Valhalla on the inner loop of Rice campus. Remaining attendees may walk to Keck Hall/Valhalla or return to the hotel.</td>
  </tr>
  <tr>
...
<table style="border-collapse:collapse; width:100%;">
  <tr>
    ...
    <td style="padding:6px;"><strong>Session III:</strong> Drug Discovery, Novel Therapeutics &amp; Clinical Context (Chair: Jesús Romo) </td>
  </tr>
  <tr>
    <td style="text-align:right; font-weight:bold; padding:6px;">9:45 – 10:15 AM</td>
    <td style="padding:6px;">Elevator talks (3 min each) (Chair: Luis Vega)</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td style="padding:6px;"><strong>Session IV:</strong> Fungal pathogenesis (Chair: Alison Coady)</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td style="padding:6px;"><strong>Session V:</strong> Interkingdom Interactions &amp; Genetic Tools/Systems (Chair: Pedro Miramón) </td>
  </tr>
  <tr>
